...
const StoreCard = ({produc}) => {
    ...
    const handleClick =()=>{
        dispatch({type:"ADD",payload:produc})
    }
  return (
      <div className="flex justify-center w-[400px]">
        <div className="flex flex-col md:flex-row md:max-w-xl rounded-lg shadow-lg  bg-slate-300">
          ...
          <div className="p-6 flex flex-col justify-start">
            ...
            <button className='w-32 bg-slate-700 py-1 px-2 rounded-md text-slate-300 font-bold active:scale-95 active:bg-slate-600 mt-3' onClick={handleClick}>Add To Basket</button>
          </div>
        </div>
      </div>
  )
